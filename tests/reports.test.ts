...
test('Thai midnight, voided bills, weighted costs and cash flow are distinct',()=>{
 ...
 sales:[{id:'s',total:200,cost:120,payment:'cash',created_at:'2026-09-08T17:00:00Z',voided_at:null},{id:'v',total:100,cost:60,payment:'transfer',created_at:'2026-09-09T03:00:00Z',voided_at:'2026-09-09T04:00:00Z'}],
 items:[{sale_id:'s',quantity:2},{sale_id:'v',quantity:1}],
